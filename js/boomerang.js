...
boomerang.factory('Config',function(){
    return {
        //modify these
        'name'          : 'GDG Paris',
        'id'            : '100575125902423385750',
        'google_api'    : 'AIzaSyB8uvtp7aReGCUBsmN3EJE0IWNeV5YBQ_w',
        'pwa_id'        : '100575125902423385750', //picasa web album id, must belong to google+ id above
        'cover' : {
            title : 'Cover Title',
